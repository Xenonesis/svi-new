    ...
    const headersList = [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: `default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://vercel.live https://*.vercel-scripts.com https://www.googletagmanager.com https://js.hcaptcha.com${__impeccableLiveDev}; worker-src 'self' blob:; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://hcaptcha.com https://*.hcaptcha.com; font-src 'self' https://fonts.gstatic.com; img-src 'self' data: blob: https://*.supabase.co https://maps.googleapis.com https://maps.gstatic.com https://images.unsplash.com; media-src 'self' https://*.supabase.co; connect-src 'self' https://*.sentry.io https://*.supabase.co wss://*.supabase.co https://api.groq.com https://api.resend.com https://hcaptcha.com https://*.hcaptcha.com; frame-src 'self' https://newassets.hcaptcha.com https://js.hcaptcha.com https://www.google.com https://*.google.com; frame-ancestors 'none';`,
          },
        ],
      },
    ];
