...
[iconsDir, faviconsDir, screenshotsDir, resourcesDir].forEach((dir) => {
...
async function main() {
  ...
  console.log('\n5. Generating Apple touch icons (Navbar Capsule Style)...');
  ...
  console.log('\nAll favicons, App Router icons, and PWA assets generated successfully from official Navbar emblem.');
}
