...
- **UI/UX Design Concept:**
  ...
  - क्लिक करने पर एक स्लीक ग्लासमोर्फिक (Glassmorphic) चैट विंडो खुलेगी जिसमें टाइपिंग इंडिकेटर और पहले से तय सुझाव (जैसे _"Jaipur properties under 40L"_) होंगे।
...
- **Technical Architecture:**
  ...
  - गणितीय फॉर्मूले का उपयोग करके रीयल-टाइम कैलकुलेशन:
    ...
    _(जहाँ $P$ = Principal Amount, $r$ = Monthly Interest Rate, $n$ = Monthly Tenure)_
...
- **UI/UX Design Concept:**
  - एडमिन पैनल के हाजिरी कंपोनेंट (`MarkAttendance.tsx`) में चेक-इन बटन दबाने पर एक लाइव लोडिंग स्पिनर जो लिखेगा _"Verifying location..."_।
  - दायरे के अंदर होने पर ग्रीन टिक के साथ हाजिरी मार्क होगी; बाहर होने पर रेड अलर्ट दिखेगा जिसमें साइट से उनकी दूरी (जैसे _"You are 2.5 km away from Shyam Aangan site"_) दिखाई देगी।
- **Technical Architecture:**
...
- **Technical Architecture:**
  ...
  - यह ट्रिगर एक व्हाट्सएप टेम्पलेट मैसेज भेजेगा (जैसे: _"नमस्ते {{name}}, आपके प्लॉट {{plot_no}} का अलॉटमेंट लेटर जारी हो गया है। डाउनलोड करने के लिए क्लिक करें: {{link}}"_)।
- **Supabase Schema Changes:**
...
- **How it works:** एक के बाद एक एनिमेटेड प्रश्न (उदा. _"आपका उद्देश्य क्या है? - निवेश या स्वयं का घर"_, _"आपका बजट क्या है?"_, _"पसंदीदा लोकेशन क्या है?"_)।
...
- **How it works:** ग्राहक जिन प्रोजेक्ट्स को सिलेक्ट करेंगे, सिस्टम फ्रंटएंड पर ही jsPDF का उपयोग करके एक कस्टमाइज्ड ब्रोशर बनाएगा जिसपर लिखा होगा: _"Prepared Custom Brochure for [Client Name]"_।

---

_© 2026 SVI Infra Solutions Pvt. Ltd. All rights reserved. Confidential Roadmap._
