      ...
      >
        ...
        <div className="bg-gray-50 p-5 transition-colors sm:p-8 dark:bg-gray-800">
          ...
          <Link
            ...
            className="text-brand-navy group-hover:text-brand-gold touch-target touch-lux inline-flex items-center gap-2 py-1 text-xs font-semibold tracking-wider uppercase transition-colors dark:text-gray-200"
          >
            {exploreLabel}
            <ArrowRight
              size={14}
