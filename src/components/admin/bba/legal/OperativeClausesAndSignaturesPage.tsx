  ...
  return (
    <>
      ...
      >
        ...
        <div className="my-6">
          <p className="mb-4 text-justify text-[14.5px] leading-relaxed font-bold">
      ...
      >
        <p className="mb-4 text-justify text-[14.5px] leading-relaxed">
          12. The Allottee(s) has seen and accepted the schedule of payments (annexure-A ). The Firm
      ...
      >
        ...
        <p className="mb-4 text-justify text-[14.5px] leading-relaxed">vi) Escalation Charges.</p>
        <p className="mb-4 text-justify text-[14.5px] leading-relaxed">
