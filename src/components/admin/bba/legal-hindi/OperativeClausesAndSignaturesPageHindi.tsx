    ...
    <>
      <div data-pdf-page="true" className={BBA_A4_PAGE_CLASS} style={BBA_A4_PAGE_STYLE}>
        ...
        <p className="mb-4 text-justify text-[15px] leading-relaxed">
          ...
          करार (BBA) में तय व निर्धारित राशि के तहत भुगतान की गई राशि ही शामिल मानी जाएगी, तथा इस
          करार में तय राशि के अलावा कोई भी अन्य राशि इसमें शामिल नहीं होगी। शेष 40% (चालीस प्रतिशत)
          राशि रद्दीकरण शुल्क के रूप में फर्म द्वारा जब्त मानी जाएगी। उक्त स्वीकार्य रिफंड राशि
          औपचारिक रद्दीकरण अनुरोध प्राप्त एवं स्वीकृत होने की तिथि से 90 (नब्बे) कार्य दिवसों के बाद
          फर्म द्वारा वापस की जाएगी।
        </p>
        <p className="mb-4 text-justify text-[15px] leading-relaxed">
      ...
      <div data-pdf-page="true" className={BBA_A4_PAGE_CLASS} style={BBA_A4_PAGE_STYLE}>
        ...
        <p className="mb-4 text-justify text-[15px] leading-relaxed">
          ...
          आवंटी(यों) द्वारा 6 (छह) ईएमआई (EMI) किश्तें जमा नहीं की जाती हैं (6 ईएमआई नहीं दी जाती
          हैं), तो यह भूखंड/आवंटन स्वतः (automatically) रद्द (cancel) हो जाएगा।
        </p>
