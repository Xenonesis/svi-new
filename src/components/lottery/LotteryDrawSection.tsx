...
export default function LotteryDrawSection() {
  ...
  if (error) {
    return (
      <section className="bg-brand-bg dark:bg-brand-dark-bg dark:border-brand-gold/20 relative overflow-hidden border-b border-transparent py-24">
  ...
  // ── Main Render ────────────────────────────────────────────────────────
  return (
    <section className="bg-brand-bg dark:bg-brand-dark-bg dark:border-brand-gold/20 relative overflow-hidden border-b border-transparent py-24 text-slate-800 transition-colors duration-500 dark:text-slate-200">
      {/* Background effects */}
