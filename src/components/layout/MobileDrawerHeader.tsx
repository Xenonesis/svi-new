  ...
  return (
    <div className="absolute top-[max(1.25rem,env(safe-area-inset-top))] right-5 left-5 flex items-center justify-between gap-2">
      ...
      <div className="flex items-center gap-1.5 min-[380px]:gap-2">
        ...
        <button
          onClick={onClose}
          className="touch-target border-gray-150 text-brand-navy flex min-h-[44px] min-w-[44px] items-center justify-center rounded-full border bg-gray-50/80 transition-all duration-300 hover:bg-gray-100 dark:border-white/15 dark:bg-white/10 dark:text-gray-200 dark:hover:bg-white/20"
