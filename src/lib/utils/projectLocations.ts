...
const STATIC_PROJECT_LOCATIONS: Record<string, ProjectLocationDetail> = {
  ...
  'shyam-aangan': {
    legalLocationHi: 'ग्राम बासंडी खुर्द, तहसील किशनगढ़ रेनवाल, जिला जयपुर, राज्य – राजस्थान',
    legalLocationEn:
      'Village Basri Khurd, Tehsil Kishan Garh Renwal, Dist. Jaipur, State – Rajasthan',
    shortLocationHi: 'बासंडी खुर्द, किशनगढ़ रेनवाल, जिला जयपुर, राजस्थान',
    shortLocationEn: 'BASRI KHURD, KISHAN GARH RENWAL, JAIPUR, RAJASTHAN',
    coverLocationHi: '(ग्राम बासंडी खुर्द, तहसील किशनगढ़ रेनवाल, जिला जयपुर, राजस्थान)',
    coverLocationEn: '(Village Basri Khurd, Tehsil Kishangarh Renwal, District Jaipur, Rajasthan)',
    cityHi: 'जयपुर, राजस्थान',
    cityEn: 'JAIPUR, RAJASTHAN',
  },
};
