    ...
    <div className="space-y-6 pb-6">
      ...
      <div>
        ...
        <p className="text-xs text-slate-500 dark:text-slate-400">
          Official staff badge and workspace preferences
        </p>
      </div>
      ...
      <div className="space-y-3 rounded-2xl border border-slate-200/80 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900/60">
        ...
        <div className="space-y-2 text-xs">
          ...
          <div className="flex items-center justify-between py-1.5">
            ...
            <span className="font-semibold text-slate-900 dark:text-white">200m GPS Verified</span>
          </div>
        </div>
      </div>

      {/* Preferences & Settings */}
      <div className="space-y-4 rounded-2xl border border-slate-200/80 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900/60">
        <h3 className="text-xs font-bold tracking-wider text-slate-500 uppercase dark:text-slate-400">
